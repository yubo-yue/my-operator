...
import (
	...
	"github.com/yubo-yue/my-operator/first-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8a6fba83.example.com",
	...
	if err = (&controller.FirstAppReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "FirstApp")
		os.Exit(1)
	}
